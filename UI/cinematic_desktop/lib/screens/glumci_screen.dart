...
import 'package:cinematic_desktop/screens/glumac_form_screen.dart'; // Dodaj import!
...
class _GlumciScreenState extends State<GlumciScreen> {
  ...
  void _showGlumacDetalji(Glumac glumac) {
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            title: Text("${glumac.ime ?? ''} ${glumac.prezime ?? ''}"),
            content: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                _buildImage(glumac.slikaBase64),
                              ...
                              child: Stack(
                                children: [
                                  Positioned.fill(
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(12),
                                      child: _buildImage(glumac.slikaBase64),
                                    ),
                                  ),
                                  Positioned(
                                    left: 0,
