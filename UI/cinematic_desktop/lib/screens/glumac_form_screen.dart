...
class GlumacFormScreen extends StatefulWidget {
  final Glumac? item;
  const GlumacFormScreen({super.key, this.item});

  @override
  State<GlumacFormScreen> createState() => _GlumacFormScreenState();
}

class _GlumacFormScreenState extends State<GlumacFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.item == null ? "Dodaj glumca" : "Uredi glumca"),
      ),
      body:
          _isLoading
