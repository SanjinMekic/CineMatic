            ...
            title: Row(
              children: [
                CircleAvatar(
                  radius: 28,
                  backgroundImage:
                      reziser.slikaBase64 != null &&
                              reziser.slikaBase64!.isNotEmpty
                          ? MemoryImage(base64Decode(reziser.slikaBase64!))
                          : null,
                  child:
                      (reziser.slikaBase64 == null ||
                              reziser.slikaBase64!.isEmpty)
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    if (reziser.rezisiraniFilmovi != null &&
                        reziser.rezisiraniFilmovi!.isNotEmpty)
                      Padding(
                        padding: const EdgeInsets.only(bottom: 12),
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                                                      ...
                                                      >(
                                                        ...
                                                        builder:
                                                            (
                                                              ...
                                                              content: Text(
                                                                "Da li ste sigurni da želite obrisati '${reziser.ime ?? ''} ${reziser.prezime ?? ''}'?",
                                                              ),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed:
