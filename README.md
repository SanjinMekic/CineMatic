...
2. Pozicionirati se u klonirani repozitorij te u terminalu pokrenuti komandu:

3. docker-compose up --build

4. Sačekati da se backend i baza uspješno buildaju. ⏳
...
3. Datum isteka: bilo koji budući datum

5. CVC: bilo koji trocifreni broj

7. ZIP kod: bilo koji petocifreni broj
